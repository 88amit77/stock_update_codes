...
def main():
    ...
    # master files
    master_filename = 'master_refresh_update20_test1_' + str(int(datetime.timestamp(datetime.now()))) + '.csv'
    ...
    # snapdeal files
    snapdeal_filename = 'master_refresh_snapdeal_update20_test1_' + str(
    ...
    while l_index <= len(l) - 1:
        ...
        # snapdeal files
        snapdeal_filename = 'master_refresh_snapdeal_update20_test1_' + str(int(datetime.timestamp(datetime.now()))) + '.csv'
        snapdeal_filefrom = '/tmp/' + snapdeal_filename
        snapdeal_fileto = '/buymore2/bin_reco/master_stock/' + snapdeal_filename
        snapdeal_update_csv = open(snapdeal_filefrom, 'w')
        snapdeal_fieldnames = ['product_id', 'quantity', 'message', 'status']
