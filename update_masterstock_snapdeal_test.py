...
def main():
    ...
    # master files
    master_filename = 'master_refresh_update_all_test_' + str(int(datetime.timestamp(datetime.now()))) + '.csv'
    ...
    # snapdeal files
    snapdeal_filename = 'master_refresh_snapdeal_update_all_test_' + str(
    ...
    for item  in binreco:
        ...
        #     warehouse_id)
        query = "SELECT * from api_masterstock where product_id = " + str(product_id) + " and warehouse in ('4','3','7','10')"
