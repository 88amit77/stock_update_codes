...
def main():
    ...
    # master files
    master_filename = 'master_refresh_update1010_' + str(int(datetime.timestamp(datetime.now()))) + '.csv'
    ...
    # snapdeal files
    snapdeal_filename = 'master_refresh_snapdeal_update1010_' + str(
    ...
    for message in uploadids:
        ...
        while page < total_pages:
            ...
            if 'message' in res['metadata']:
                ...
                print("snapdeal_quantity===outer==", snapdeal_quantity)
