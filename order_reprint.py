...
def get_snapdeal_accounts(cur_products):
    ...
    if portal is not None:
        portal_id = portal[0]
        cur_products.execute("Select * from master_portalaccountdetails where account_id =10 and portal_id_id = " + str(portal_id))
...
def lambda_handler():
    ...
    for account in accounts:
        for warehouse in account['warehouses']:
            ...
            print("approved_orders==>",approved_orders)
    ...
    dbx.files_upload(error_log.encode(), '/buymore2/orders/invoices/logs/snapdeal_order_reprint_error_log' + str(
